...
import webTrade from "../assets/webTrade.png";
const WebTrade = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
          ...
          <div className="webTrader__content">
            <div className="webTrader__content-text">
              ...
              <p>
                ...
                Our web Trader has been built with one purpose in mind and
                that's to improve the trading experience of our clients.
              </p>
            </div>
